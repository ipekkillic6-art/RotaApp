...
export const lightColors: ThemeColors = {
  ...
  action: {
    ...
    secondaryPressed: palette.blue[100],
  ...
  status: {
    ...
    assigned: palette.blue[600],
    accepted: palette.blue[600],
    pickedUp: palette.blue[700],
    onTheWay: palette.blue[700],
  ...
  statusSurface: {
    ...
    assigned: palette.blue[50],
    accepted: palette.blue[50],
    pickedUp: palette.blue[100],
    onTheWay: palette.blue[100],
  ...
  role: {
    customer: palette.blue[600],
    courier: palette.violet[600],
    admin: palette.slate[700],
  },
  roleSurface: {
    customer: palette.blue[50],
  ...
  map: {
    ...
    route: palette.blue[500],
    marker: palette.blue[700],
  },
};
...
export const darkColors: ThemeColors = {
  ...
  status: {
    ...
    assigned: palette.blue[300],
    accepted: palette.blue[300],
    pickedUp: palette.blue[200],
    onTheWay: palette.blue[200],
  ...
  map: {
    ...
    route: palette.blue[400],
    marker: palette.blue[300],
  },
};
